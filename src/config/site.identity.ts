export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'aquijano',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Aquijano',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'aquijano.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://aquijano.com',
